...
<VirtualHost _default_:443>
	ServerAdmin info@etherpad.conext.surfnetlabs.nl
	ServerName etherpad.conext.surfnetlabs.nl

	DocumentRoot /var/www/etherpad.conext.surfnetlabs.nl/
	<Directory />
		Options FollowSymLinks
		AllowOverride None
	</Directory>
	<Directory /var/www/etherpad.conext.surfnetlabs.nl/>
  ...
  <Directory /var/www/etherpad.conext.surfnetlabs.nl/eplconext/gadget>
	...
	# Proxy for EtherpadLite at localhost:9001
	#<LocationMatch  "^/(?!eplconext).*">
#	<LocationMatch  (?!eplconext)>
#		ProxyPass http://localhost:9001
#		ProxyPassReverse http://localhost:9001
#	</LocationMatch>
# LocationMatch does not work, so do it with mod_rewrite instead...
...
RewriteRule /(.*)$	http:///bla.bla.bla/$1 [L]
	...
	Alias /simplesaml /var/www/etherpad.conext.surfnetlabs.nl/eplconext/lib/simplesamlphp-1.8.0/www
	...
	#SSLCertificateFile    /usr/local/etc/ssl/cert-6704-_.conext.surfnetlabs.nl.pem
	...
	#SSLCertificateChainFile /usr/local/etc/ssl/star.conext.surfnetlabs.nl.CHAIN.pem
